...
export class CarDetailsComponent {
  ...
  constructor(
    public mainPageServices: MainPageService,
  ...
  rentNow() {
    if (!this.pickUp.getFormValid()) {
      return;
    }
    console.log(this.pickUp.getFormValue(), this.dropOff.getFormValue());
    this.commonMethods.rentNowForBilling(
      this.car._id,
      this.pickUp.getFormValue(),
      this.dropOff.getFormValue()
    );
  }
}
